...
class ProductAttributeSelect implements \Magento\Framework\Option\ArrayInterface
{
    ...
    public function toOptionArray()
    {
        ...
        $writer = new \Zend\Log\Writer\Stream(BP . '/var/log/tempslog.log');
        $logger = new \Zend\Log\Logger();
        $logger->addWriter($writer);

        $logger->info("Info:   ".\GuzzleHttp\json_encode($attributeList));
        $logger->info("Info:   ".\GuzzleHttp\json_encode($attributeList->getItems()));
